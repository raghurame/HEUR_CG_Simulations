...
#define NTHREADS 5
#define INPUTFILE "last.lammpstrj"
...
#define OUTPUT_BRIDGESBETWEENBINS "nBridgesBetweenBins.count"
#define OUTPUT_YDISTRIBUTIONBRIDGES "bridges.distribution"
#define OUTPUT_BONDCENTERDISTRIBUTION "bridgeCenter.distribution"
